...
const Market: FC<MarketProps> = ({
  ...
  return (
    <div className="bg-[#F1F1F0] relative flex  max-sm:flex-col max-sm:items-center  flex-wrap justify-center gap-[30px]  px-[20px]  max-md:gap-[10px] py-[100px] max-md:py-[80px] min-h-screen ">
