  ...
  return (
    ...
    >
      <div className="flex flex-col justify-between items-center w-full">
        <button
          className="flex justify-between items-center  font-[500] w-full"
          onClick={() => setActiveQuestion(activequestion ? null : props.id)}
        >
          ...
          <div className="text-start focus:outline-none   flex  flxe-col items-center justify-center ">
            {activequestion ? (
              <FaMinus
                onClick={() =>
                  setActiveQuestion(activequestion ? null : props.id)
                }
              />
            ) : (
              <FaPlus
