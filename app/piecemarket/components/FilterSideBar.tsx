...
import Price from "@/app/piecemarket/components/Price";
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className={`grid grid-cols-[1fr_1fr_1fr] gap-x-[40px] max-sm:grid-cols-[1fr_1fr]  pt-[20px] w-full max-md:gap-[20px] bg-white rounded-2xl md:shadow-sm px-[3vw]  `}
            >
