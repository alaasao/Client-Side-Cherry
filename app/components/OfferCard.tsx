...
const OfferCard: FC<OfferCardProps> = ({ id, img }: OfferCardProps) => {
  return (
    <div className=" relative w-full h-full group cursor-pointer ">
      ...
      <Link href={""} className="absolute z-[-1] w-full h-full top-0 pb-[80px] bg-[#696564] text-3xl rounded-xl opacity-[90%]  justify-normal items-center  text-center flex group-hover:z-[3]">
        {" "}
