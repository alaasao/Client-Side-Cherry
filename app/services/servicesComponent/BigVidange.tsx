...
const BigVidange = () => {
  return (
    <div className='w-[90%]  justify-center items-center max-md:hidden'>
        ...
        <p className='text-lg font-[500] mb-6'>Dans notre section dédiée aux services chez Chery Algerie , nous nous engageons à maintenir votre véhicule en parfait état de fonctionnement. Planifiez votre viLittledange en ligne dès maintenant.</p>
        ...
        <div className="w-full h-full absolute top-0 left-0 grid grid-cols-[3fr_1fr] lg:grid-cols-[2fr_1fr]  gap-[20px]  justify-center  text-black ">
            <form>
                <div className='bg-[#ECECEC] w-full py-4 pl-4 relative flex flex-col 2xl:h-[800px] h-full  items-start 2xl:items-center justify-between lg:justify-around rounded-r-[60px]'>
                    <h1 className='text-2xl lg:text-3xl 2xl:tex-4xl font-bold '>Prenez rendez-vous</h1>
                    ...
                    <div className='flex items-center 2xl:items-start w-[80%] justify-center'>
                            <button  className='text-[#D12621] border rounded-[10px] relative  z-10 text-nowrap good text-xs  w-[200px]  md:w-[250px] 2xl:w-[500px]  font-good  mt-4 h-4  animation'  type='submit'>
